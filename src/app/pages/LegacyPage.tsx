import { faChartLine, faScroll, faSeedling, faShield } from "@fortawesome/free-solid-svg-icons";
...
function GivingMethodItem({ color, icon, title, body }: { color: string; icon: IconProp; title: string; body: string }) {
	return (
		<div className="flex gap-[16px] items-start">
			<div className={`${color} rounded-full size-[48px] flex items-center justify-center shrink-0`}>
	...
	return (
		<div className="size-full relative">
			...
			<section className="relative w-full bg-cma-navy overflow-hidden flex flex-col items-center justify-center py-[80px] md:py-[120px]">
				...
				<p className="relative z-[1] text-white/50 text-[12px] text-center leading-[1.6] max-w-[560px] mx-auto px-5 mt-6">
