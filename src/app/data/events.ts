...
export const allEvents: EventItem[] = [
  {
    ...
    description: "Enjoy a sensory-modified experience on select Sunday mornings. This experience includes lowered lighting, limited admission and sound adjustments.",
  ...
  },
  {
    ...
    description: "Members enjoy exclusive early access every day in August. Explore your favorite exhibits before doors open to the public.",
  ...
  },
  {
    ...
    title: "TinyCON®",
    description: "A kid-sized comic convention celebrating imagination, creativity, and pop culture. Costumes encouraged — all ages welcome!",
    categories: ["Featured", "Special Events"],
    paragraphs: [
  ...
  },
  {
    ...
    description: "Step inside Gabby's Dollhouse for a magical weekend of creativity and play inspired by the beloved Netflix series.",
  ...
  },
  {
    ...
    description: "Bring your little ghouls and goblins for a safe, indoor Halloween treat trail through the museum. Costumes required, candy guaranteed.",
  ...
  },
  {
    ...
    title: "Bubble Bash",
    description: "Ring in the New Year early with our family-friendly countdown celebration featuring giant bubbles, dancing, and a noon confetti drop!",
    categories: ["Featured", "Special Events"],
    paragraphs: [
  ...
  },
  {
    ...
    title: "Artsy Mondays",
    description: "Dive into open-ended art-making every Monday as part of our Building Blocks series. Drop in anytime during museum hours.",
