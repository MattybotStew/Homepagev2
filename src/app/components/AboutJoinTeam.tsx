...
import imgTeam from "../../assets/about6.png";
			...
			<div className="cma-section-container flex flex-col lg:flex-row gap-10 lg:gap-[80px] items-start">
				...
				>
					<div className="rounded-[24px] overflow-hidden h-[320px] lg:h-[480px]">
						<img
							src={imgTeam}
							alt="Children's Museum of Atlanta team members"
				...
				<div className="flex-1 flex flex-col gap-6">
					...
					>
						...
						<p className="text-cma-navy">
							...
							outstanding service to our guests to help us to fulfill our
							mission of sparking imagination and inspiring discovery and
							learning for all children through the power of play.
						</p>
						<p className="text-cma-navy">
							The Museum is committed to equal employment opportunity.
							Children's Museum of Atlanta will not discriminate against
							...
							service member status, race, color, religion, sex, national
							origin, sexual orientation, gender identity, age, genetic
							information, physical or mental disability or marital status.
						</p>
					</motion.div>
