				...
				<div className="bg-white flex flex-col items-start rounded-[16px] shadow-cma-warm w-full">
					<div className="flex gap-[12px] h-[64px] items-center px-[16px] w-full">
						...
						<div className="flex-1 h-[38px] min-h-px min-w-px relative">
							<div className="flex flex-col gap-[2px] items-start relative size-full">
								<div className="h-[16px] relative shrink-0 w-full">
									<p className="font-semibold leading-[16px] text-cma-navy text-[12px] text-left whitespace-nowrap">
										Opening Times Today
									</p>
								</div>
								<div className="h-[20px] overflow-clip relative shrink-0 w-full">
									<p className="font-bold leading-[20px] text-cma-orange text-[14px] text-left whitespace-nowrap">
						...
						<div className="flex items-center justify-center relative shrink-0">
							<div
								className={`flex-none transition-transform duration-300 ${isExpanded ? "rotate-180" : "rotate-0"}`}
							>
				...
				<div className="bg-white flex flex-col items-start overflow-clip rounded-[24px] shadow-cma-panel w-full cma-slide-down">
					...
					<div className="w-full">
						<div className="flex items-center gap-[20px] p-[20px]">
							...
							<p className="font-bold leading-[28px] text-cma-navy text-[24px] whitespace-nowrap">
								Museum Hours
							</p>
						</div>
					</div>
							...
							<div className="flex flex-col gap-[12px] items-start p-[18px]">
								...
								<div className="bg-white rounded-[14px] w-full">
									<div className="flex flex-col gap-[6px] items-start p-[14px]">
										<p className="font-bold leading-[20px] text-cma-navy text-[14px] whitespace-nowrap">
											Members Early Access
										</p>
										<p className="font-semibold leading-[20px] text-cma-orange text-[14px] whitespace-nowrap">
											9:00 - 10:00 AM
										</p>
									</div>
								</div>
								...
								<div className="bg-white rounded-[14px] w-full">
									<div className="flex flex-col gap-[6px] items-start p-[14px]">
										...
										<p className="font-semibold leading-[20px] text-cma-teal text-[14px] whitespace-nowrap">
											10:00 AM - 3:30 PM
										</p>
									</div>
								</div>
