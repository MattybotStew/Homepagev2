...
const boardOfDirectors: Person[] = [
  ...
  { name: "Serena Levy", detail: "Immediate Past Chair · Southern Company Gas" },
  { name: "Dr. Seema Csukas", detail: "Secretary · Community Leader" },
  { name: "Molly Hinton", detail: "Treasurer · EY" },
  { name: "Sara Hess Mackenzie", detail: "General Counsel · Alston & Bird LLP" },
...
const boardOfAdvisors: Person[] = [
  ...
  { name: "Jane Hardesty", detail: "John H. and Wilhelmina D. Harland Charitable Foundation Inc." },
...
const administration: Person[] = [
  ...
  { name: "Gillian Skipper", detail: "Assistant Director of Facility Operations" },
...
const strategicAdvancement: Person[] = [
  ...
  { name: "Laura Halad", detail: "Assistant Director of Advancement and Special Events" },
  { name: "Peyton Corder", detail: "Strategic Advancement Manager" },
  { name: "Lilly Heidari", detail: "Corporate and Foundation Relations Manager" },
]
...
function PersonCard({ person }: { person: Person }) {
  return (
    <div className="flex flex-col gap-1 py-4 border-b border-[#e4e8ee] last:border-b-0">
      <p className="text-cma-navy font-bold text-[14px] leading-snug">{person.name}</p>
  ...
  return (
    <section className="bg-cma-cream w-full py-[80px] md:py-[120px] relative overflow-hidden" id="team">
      <div className="cma-section-container flex flex-col gap-10">
        ...
        >
          <p className="cma-eyebrow text-cma-teal">the people behind the play</p>
