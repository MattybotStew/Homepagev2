...
const boardOfDirectors: Person[] = [
	...
	{ name: "Stephanie Buzzell", detail: "The Home Depot" },
	{ name: "Fabiola Charles Stokes", detail: "Google" },
	{ name: "David Edwards", detail: "PowerA, ACCO Brands Inc." },
	{ name: "Jason Esteves", detail: "Hudson Cook, LLP" },
	{ name: "Trisha Hardy", detail: "Boys and Girls Clubs of America" },
	{ name: "Tracie Hawkins-Simpson", detail: "Kaiser Permanente" },
	{ name: "John Jackson", detail: "BlackRock" },
	{ name: "Shamika Lackey", detail: "Formerly Nike" },
	{ name: "Dr. Marissa Pace", detail: "Emory University" },
...
const boardOfAdvisors: Person[] = [
	...
	{ name: "Justin Clay", detail: "NCR Voyix" },
	...
	{ name: "Willson Overend", detail: "Verily" },
