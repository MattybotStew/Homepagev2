...
export default function EducatorsImpact() {
  ...
  return (
    <section id="contact" className="bg-cma-navy w-full py-[80px] md:py-[120px] relative">
        ...
        <div className="flex flex-col lg:flex-row gap-[48px] lg:gap-[60px]">
          ...
          >
            <div className="flex flex-col gap-[24px]">
              <h2 className="text-white leading-none">Making an Impact Together</h2>
              <p className="text-cma-blue-light text-[clamp(15px,1.25vw,18px)] leading-[1.7]">
                At CMA, we're more than a museum — we're a nonprofit dedicated to sparking curiosity in every child. We rely on supporters to keep inspiring over 100,000 young minds annually through interactive programs and community outreach.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-[32px]">
              {impactItems.map((item, i) => (
                ...
                >
                  <div className={`${item.color} rounded-[14px] size-[48px] flex items-center justify-center shrink-0`}>
                    <div className="bg-white/50 rounded-[6px] size-[24px]" />
                  </div>
                  <div className="flex flex-col gap-[8px]">
                    <p className="font-extrabold text-[18px] text-white leading-[1.2]">{item.title}</p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="#donate" className="cma-btn bg-cma-orange text-cma-navy hover:bg-cma-orange-dark font-black">
                Make Play Possible — Donate
              </a>
              <a href="#learn-more" className="cma-btn bg-white border-2 border-cma-teal-dark text-cma-teal-dark hover:bg-cma-teal-dark hover:text-white font-black">
                Learn More
              </a>
            </div>

            <p className="text-white/60">501(c)(3) organization — your support makes play possible</p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white border-2 border-black/5 rounded-[24px] p-[24px] flex flex-col gap-[24px]">
              <div className="rounded-[16px] overflow-hidden h-[220px] shrink-0">
                <img src={imgContact} alt="Education team" className="w-full h-full object-cover" />
              </div>
              <p className="font-extrabold text-[24px] text-cma-navy leading-[1.2]">Meet Your Education Contact</p>
              <p className="text-cma-navy">
                Our education team at CMA is ready to help you plan your next field trip or program. Get in touch and let us know how we can help!
              </p>
              <a href="mailto:education@childrensmuseumatlanta.org" className="cma-btn bg-cma-orange text-cma-navy hover:bg-cma-orange-dark font-black self-start">
            ...
            <div className="bg-cma-cream rounded-[20px] px-[40px] py-[32px] flex flex-col gap-[20px] items-center">
              ...
              <p className="text-[#6b7ea0] text-center">
                Stay up to date on new programs, professional development opportunities, and free educator resources.
              </p>
              <form
              ...
              >
                <div className="bg-white border border-cma-blue-light rounded-[10px] flex items-center gap-[12px] px-[16px] py-[14px]">
                  <svg className="size-[20px] text-cma-blue-mid shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <button type="submit" className="cma-btn bg-cma-orange text-cma-navy hover:bg-cma-orange-dark font-black w-full justify-center">
                  Stay In The Loop!
                </button>
              </form>
            </div>
