          ...
          <div className="bg-white rounded-[24px] border-2 border-black/5 p-[24px] md:p-[48px] flex flex-col gap-[32px] md:gap-[48px]">
            ...
            <div className="relative">
              ...
              <div className="absolute top-[20px] left-[23px] bg-cma-teal-dark rounded-[8px] px-[18px] py-[12px]">
                <p className="text-white text-[14px] font-bold leading-[1.5]">{event.badge}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a href="#/events" className="cma-btn bg-white border-2 border-cma-teal-dark text-cma-teal-dark hover:bg-cma-teal-dark hover:text-white font-black">
                View All Events
              </a>
            </div>
            ...
            <div className="flex flex-col gap-[48px]">
              <p className="text-cma-navy font-extrabold text-[28px] md:text-[36px] leading-[1.1]">More Events</p>
              <div className="flex flex-col gap-[16px]">
                {related.map((rel, i) => (
                  <motion.div
                    key={rel.slug}
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-[20px] md:gap-[32px] flex-1 min-w-0 md:justify-center">
                      <div className="flex flex-col gap-[8px] md:gap-[16px]">
                        <p className="text-cma-teal-dark text-[13px] font-bold">{rel.badge}</p>
                        <p className="text-cma-navy font-extrabold text-[24px] md:text-[30px] leading-[1.3] tracking-[-0.5px] md:tracking-[-1px]">{rel.title}</p>
                      </div>
                      <p className="text-cma-navy line-clamp-3">{rel.description}</p>
                      <a href={`/#/events/${rel.slug}`} className="cma-text-link">
                        See Event <FontAwesomeIcon icon={faArrowRight} className="text-[13px]" />
                      </a>
                    </div>
                  </motion.div>
                ))}
