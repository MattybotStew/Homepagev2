...
export default function Header() {
  ...
  return (
    <header className="fixed top-[34px] xs:top-[36px] sm:top-[40px] md:top-[44px] left-0 right-0 z-40 w-full shadow-sm" style={{ background: 'linear-gradient(90deg, #4AD1DC 0%, #00ADBB 100%)' }}>
