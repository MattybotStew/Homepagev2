...
export default function ExhibitsHero() {
	return (
		<>
			{/* Heading band */}
			<section className="bg-cma-cream w-full pt-[60px] pb-[80px] md:pt-[80px] md:pb-[120px] relative">
			...
			{/* Featured Exhibits band */}
			<section className="bg-white w-full pt-[80px] pb-[80px] md:pt-[120px] md:pb-[120px] relative">
