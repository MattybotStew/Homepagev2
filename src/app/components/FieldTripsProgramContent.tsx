...
const learningZones = [
  {
    ...
    description: "Travel the world and explore six continents and climb among the planets.",
  },
  {
    title: "Fundamentally Food",
    description: "Follow the food we eat from farm to table! Milk Buttercup, the Museum's cow, and pick vegetables from a garden. Ship the harvest to the local store and purchase it from the shelves of the grocery. Create a nutritious meal at the Museum's pretend diner.",
  },
  {
    title: "Let Your Creativity Flow",
    description: "Explore the science of color at the Museum's paint wall and build topographical landscapes at the augmented reality sand table.",
  },
  {
    title: "Tools for Solutions",
    description: "Learn about the six simple machines with the Museum's giant ball machine. Explore electricity and connect pipes at the construction house. Design and test a structure against earthquakes.",
  },
  {
    title: "Step Up to Science",
    description: "Learn about the science of light and sound in Catch a Wave. Designed to enhance children's STEAM understanding, Step Up to Science also offers opportunities to explore engineering in Jane's Innovation Station.",
  },
]
...
const featuredExhibits = [
  ...
  },
  {
    ...
    description: "Explore a magical place and time! Find your role in the castle community and wake a sleeping dragon.",
    href: "#",
  },
]
...
const faqItems = [
  {
    ...
    answer: "Space is limited and dates go quickly, so reserve early! A 50% non-refundable credit card or check deposit is required within two weeks of booking. Have at least three possible dates selected for your visit as well as the number of students and adults (one adult for every five students is required). Additional adults must be booked through the school. Final payment for all in-person programs is due on the day of the visit. Call Reservations at 404.527.3693, email reservations@childrensmuseumatlanta.org, or fill out our online request form.",
  },
  {
    question: "Cancellations",
    answer: "Call as soon as possible to change a reservation. Reservations are held with a 50% non-refundable deposit. Organizations must cancel within six (6) weeks of the scheduled program to apply the deposit to a different date within the same school year. Rescheduling a program is based on availability. Cancellations made less than six (6) weeks prior to visit will result in forfeiture of 50% deposit.",
  },
  {
    question: "Chaperones",
    answer: "The Museum defines a chaperone as any adult (including teachers), 18 years and older attending the field trip. One chaperone is required for every five students. Required chaperones are free at the 1:5 student to chaperone ratio. Chaperones must remain with their students at all times. Group will not be admitted until all required chaperones have arrived. Additional adult chaperones MUST be reserved/paid through the school for an admission fee of $15.95 plus tax per person. For security purposes, adults with tickets purchased separately via website will not be admitted.",
  },
  {
    question: "Capacity",
    answer: "The Museum has a maximum field trip capacity of 250 people (this includes students, teachers and all adults). One adult (teachers & caregivers) is required for every 5 students. These required adult chaperones are free. All additional adults must pay chaperone pricing. We require 10 students minimum to qualify for field trip pricing.",
  },
  {
    question: "Lunch",
    answer: "There are two rooms available for field trip groups to eat lunch at a rate of $50 per room. Each room has a limited capacity of 36 people (30 students and 6 required chaperones per room). Field trips may book up to 4 lunch sessions per visit (120 total students). Centennial Olympic Park, across the street from the Museum, is a popular picnic lunch destination.",
  },
  {
    question: "Payment",
    answer: "School checks made out to Children's Museum of Atlanta, cash, or credit cards (Visa, MasterCard, Discover and American Express), or Bill.com. Please include mailing address for checks. School check or school credit card must be used for tax exempt status.",
  },
  {
    question: "Parking",
    answer: "Full-size buses can park at the Georgia World Congress Center Marshalling Yard for a fee. Parking must be purchased online directly through GWCC. Parking is not provided by Children's Museum of Atlanta. Please ask for parking suggestions when booking your field trip. We recommend pre-purchasing parking at 236 Williams Street, located one block away.",
  },
  {
    question: "Sensory Packs",
    answer: "The Museum has a limited quantity of sensory packs to borrow during your visit. Sensory packs include headphones, sunglasses, and various fidget toys. Please let Reservations know if you need to reserve any sensory packs for your group.",
  },
  {
    question: "Target Ages",
    answer: "Our target ages for field trips are preschool to third grade. Looking for programming for fourth and fifth grade? Check out our Museum On-the-Go programs!",
  },
  {
    question: "Tax Exempt",
    answer: "Provide the Museum's Reservations Department with your Tax Exemption Certificate prior to your deposit payment. Refunds cannot be issued for tax that has been paid. Please ensure all forms have been received and your order is accurate prior to arrival.",
  },
]
...
const tripDetails = [
  {
    ...
    label: "Age Range",
    description: "PreK through 5th grade — structured by grade level for a tailored experience.",
  },
  {
    icon: faClock,
    color: "bg-cma-orange",
  ...
  },
  {
    ...
    color: "bg-cma-slate",
    label: "Group Size",
    description: "Minimum 10 students, maximum 250 people including chaperones.",
  },
  {
    icon: faGraduationCap,
    color: "bg-[#3a9e6e]",
    label: "Learning Focus",
    description: "Play-based, inquiry-driven exploration aligned to Georgia Standards of Excellence.",
  },
]
...
const standards = [
  {
    ...
    color: "bg-cma-teal-dark",
    label: "Math & Science",
    description: "Hands-on STEAM concepts embedded throughout all exhibit zones.",
  },
  {
    icon: faGlobe,
    color: "bg-cma-orange",
    label: "Social Studies",
    description: "Community, culture, and geography explored in Gateway to the World.",
  },
  {
    icon: faBook,
    color: "bg-cma-slate",
    label: "Language Arts",
    description: "Literacy and communication skills woven into every facilitated activity.",
  },
  {
    icon: faBrush,
    color: "bg-[#3a9e6e]",
    label: "Arts & STEAM",
    description: "Creative expression and engineering in Let Your Creativity Flow and Tools for Solutions.",
  },
]
        ...
        <div className="flex gap-[40px] xl:gap-[56px] items-start">
          ...
          <aside className="hidden lg:flex flex-col gap-[20px] w-[210px] shrink-0 sticky top-[140px] self-start">
            ...
            <div className="bg-cma-navy rounded-[20px] p-[20px] flex flex-col gap-[12px]">
              <p className="font-extrabold text-[14px] text-white leading-[1.3]">Subscribe to Our Educator Newsletter!</p>
              <p className="text-white/75 text-[13px] leading-[1.5]">Stay in the know! Our educator newsletter keeps you updated on upcoming programs, events, and play-based learning opportunities for your classroom and community.</p>
              <input
                type="email"
          ...
          <div className="flex-1 min-w-0">
            <div className="bg-white rounded-[24px] border-2 border-black/5 p-[24px] md:p-[48px] flex flex-col gap-[32px] md:gap-[48px]">
              ...
              <div id="overview" className="flex flex-col gap-[24px]">
                ...
                <h2 className="text-cma-navy !text-[20px] !font-bold !leading-[1.3]">Field Trips Information</h2>
                ...
                <div className="bg-cma-teal-pale rounded-[16px] p-[24px] flex flex-col gap-[12px]">
                  <p className="font-extrabold text-cma-navy">Your field trip includes:</p>
                  <ul className="flex flex-col gap-[8px]">
                    {tripIncludes.map((item) => <SectionBullet key={item}>{item}</SectionBullet>)}
                  </ul>
                </div>
              ...
              <div className="bg-cma-teal-pale rounded-[16px] p-[24px] flex flex-col sm:flex-row sm:items-center gap-[16px] sm:gap-[24px]">
                <div className="flex-1">
                  <p className="font-extrabold text-cma-navy text-[16px] mb-[6px]">Ready to Book?</p>
                  <p className="text-cma-navy/70 text-[14px]">Field trips are self-guided with a 9:30 am arrival time and a field trip time of 10 am – 12 pm. A deposit is required to confirm your reservation.</p>
                </div>
                <button onClick={() => scrollToSection("request-visit")} className="cma-btn bg-cma-orange text-cma-navy hover:bg-cma-orange-dark font-black shrink-0">
                  Request Visit
                </button>
              </div>
              ...
              <div id="field-trip-details" className="flex flex-col gap-[24px]">
                ...
                <p className="text-cma-navy">
                  Field trips are scheduled for 10 am – 12 pm on Tuesdays, Thursdays, Fridays, and select Mondays and Wednesdays. Check-in is at 9:30 am. Maximum field trip capacity is 250 people (this includes students, teachers and adult chaperones). The Museum requires one (1) adult for every five (5) children.
                </p>
                <p className="text-cma-navy">
                  Required adults are free and counted towards the 250 capacity. Additional adult chaperones <strong>must</strong> be paid through the school and cannot purchase individual tickets online. Any additional adult arriving without a school-purchased ticket will be turned away.
                </p>
                ...
                <div className="bg-cma-teal-pale rounded-[16px] p-[24px] flex flex-col gap-[12px]">
                  <p className="font-extrabold text-cma-navy">Lunch Information</p>
                  <p className="text-cma-navy">
                    The Museum has limited lunch space available on a first come, first serve basis. Two rooms are available for school groups with a maximum of 36 total people per room (30 students and 6 adults). Both rooms may be booked and must be reserved at time of booking. Each room may be booked twice maximum per visit (120 student capacity). Alternatively, school groups are welcome to walk across the street to Centennial Olympic Park for a picnic lunch.
                  </p>
                  <p className="text-cma-navy/60 text-[13px]">
                    Questions about lunch? Contact our Reservations team at reservations@childrensmuseumatlanta.org.
                  </p>
                </div>
              </div>
              ...
              <div id="learning-zones" className="flex flex-col gap-[24px]">
                ...
                <p className="text-cma-navy font-semibold">
                  Permanent Exhibits — Explore our 6 year-round permanent exhibits!
                </p>
                <div className="flex flex-col gap-[0px]">
                  {learningZones.map((zone) => (
                    <div key={zone.title} className="flex flex-col gap-[6px] py-[16px] border-b border-black/8 last:border-0">
                      <p className="font-extrabold text-cma-navy">{zone.title}</p>
                ...
                <div className="bg-cma-teal-pale rounded-[16px] p-[20px] flex flex-col gap-[8px]">
                  <p className="text-cma-navy text-[13px] font-bold uppercase tracking-wide">Additional learning zone for kindergarten and younger</p>
                  <p className="font-extrabold text-cma-navy mt-[4px]">Leaping into Learning</p>
                  <p className="text-cma-navy/70">Catch a colorful fish at our pond! Go under our waterfall without getting wet. Climb into our tree house and see animals from the forest.</p>
                </div>
              </div>
              ...
              <div id="educational-standards" className="flex flex-col gap-[24px]">
                ...
                <p className="text-cma-navy">
                  Explore our grade-by-grade standards alignment and discover how our field trips support GELDS and Georgia Standards of Excellence.
                </p>
                <div className="flex flex-col">
                  {standards.map((item) => (
                    <div key={item.label} className="flex gap-[16px] items-start py-[16px] border-b border-black/8 last:border-0">
              ...
              <div id="field-trip-plus" className="flex flex-col gap-[24px]">
                ...
                <div className="bg-cma-navy rounded-[16px] p-[24px] flex flex-col gap-[12px]">
                  <p className="cma-eyebrow text-cma-orange">Enhanced Experience</p>
                  <p className="text-white">
                    Field Trip+: an enhanced field trip experience featuring guided STEAM activities and exclusive access to the Museum on select Wednesdays.
                  </p>
                  <button onClick={() => scrollToSection("request-visit")} className="cma-btn bg-cma-orange text-cma-navy hover:bg-cma-orange-dark font-black self-start">
                    Learn More & Book
                  </button>
                </div>
              </div>
                  ...
                  {featuredExhibits.map((exhibit, i) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-[10px] flex-1 min-w-0">
                        ...
                        <p className="text-cma-navy font-extrabold text-[20px] md:text-[22px] leading-[1.2] tracking-[-0.5px]">{exhibit.title}</p>
                        <p className="text-cma-navy">{exhibit.description}</p>
                        <a href={exhibit.href} className="cma-text-link">
                          Learn More <FontAwesomeIcon icon={faArrowRight} className="text-[12px]" />
                        </a>
                      </div>
                    </motion.div>
                  ))}
              ...
              <div id="availability-calendar" className="flex flex-col gap-[24px]">
                <h2 className="text-cma-navy">Field Trip Availability Calendar</h2>
                <p className="text-cma-navy">
                ...
                <div className="bg-cma-teal-pale rounded-[16px] p-[24px] md:p-[48px] flex flex-col items-center justify-center gap-[16px] text-center">
                  ...
                  <p className="text-cma-navy/60 text-[14px] max-w-[360px]">To check availability and reserve your date, contact our Reservations team at 404.527.3693 or reservations@childrensmuseumatlanta.org.</p>
                  <button onClick={() => scrollToSection("request-visit")} className="cma-btn bg-cma-teal-dark text-white hover:bg-cma-navy font-black">
                    Request a Date
                  </button>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-[24px]">
                ...
                <p className="text-cma-navy">
                  Explore 20,000 square feet of playful exhibits where children create, explore, and discover new adventures around every corner.
                </p>
                <div>
                  <a href="#" className="cma-btn bg-cma-navy text-white hover:bg-cma-navy-dark font-black">
                  ...
                  {[
                    {
                      image: imgFloor,
                      title: "Museum Floor",
                      description: "Explore six exhibits, the stage, and a sensory-friendly room. In this open, free-flowing space, students explore at their own pace, following curiosity and joy from one hands-on experience to the next, with something new to discover around every corner.",
                    },
                    {
                      image: imgMezz,
                      title: "Mezzanine",
                      description: "Take the piano stairs or elevator to the Mezzanine and play in Step Up to Science and Jane's Innovation Station. Students get hands on with STEM principles while they explore and experiment with the forces and phenomena that make our world wonderful.",
                    },
                  ].map((floor) => (
              ...
              <div id="faqs" className="flex flex-col gap-[24px]">
                ...
                <p className="text-cma-navy">Got questions? We've got answers! Find everything you need to know about visiting our museum.</p>
                <div className="flex flex-col">
                  {faqItems.map((faq, i) => (
              ...
              <div className="bg-cma-navy rounded-[20px] p-[24px] md:p-[32px] flex flex-col sm:flex-row sm:items-center gap-[24px]">
                <div className="flex-1">
                  ...
                  <p className="text-cma-blue-light font-bold mt-[8px]">Reservations Team</p>
                </div>
                <a
                  href="tel:4045273693"
              ...
              <div id="request-visit" className="flex flex-col gap-[24px]">
                ...
                <p className="text-cma-navy">
                  Field trips are all self-guided visits with a 9:30 am arrival time and a field trip time of 10 am – 12 pm. <em>*Please note that our online booking form does not guarantee a reservation — our team will reach out to you to verify your request. A deposit is required in order to confirm your reservation.</em>
                </p>
                  ...
                  <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-[16px]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-[16px]">
                      <div className="flex flex-col gap-[6px]">
                        ...
                        <input type="number" min="10" max="250" placeholder="Min. 10" className={inputClass} />
                      </div>
                      <div className="flex flex-col gap-[6px]">
                        <label className={labelClass}>Date Request – First Choice *</label>
                        <input type="date" className={inputClass} placeholder="MM/DD/YYYY" />
                      </div>
                      <div className="flex flex-col gap-[6px]">
