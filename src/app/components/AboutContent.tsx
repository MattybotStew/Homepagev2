			...
			<div className="cma-section-container">
				...
				>
					<div className="w-full lg:flex-1 rounded-[24px] overflow-hidden h-[280px] sm:h-[360px] lg:h-[480px] shrink-0">
						<img
							src={imgPlay}
							alt="Children exploring museum exhibits"
					...
					<div className="w-full lg:flex-1 flex flex-col gap-6">
						...
						<p className="text-cma-navy">
							Why is play essential for childhood development—and how does the
						...
						<p className="text-cma-navy font-black text-[clamp(16px,1.8vw,20px)] leading-[1.5]">
							"Play is not just fun—it's how children learn, grow, and discover
							who they are. Every moment at our museum is designed to spark
							curiosity, build confidence, and create lasting memories."
						</p>
					</div>
				</motion.div>
			</div>
