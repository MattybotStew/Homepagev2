...
const sections = [
  ...
  },
  {
    ...
    ctas: [
      { label: "Gift Guides", href: "#gift-guides", style: "cma-btn bg-cma-orange text-cma-navy hover:bg-cma-orange-dark" },
      { label: "Purchase CMA Merch Online", href: "#merch", style: "cma-btn bg-white border-2 border-cma-teal-dark text-cma-teal-dark hover:bg-cma-teal-dark hover:text-white" },
    ],
  },
]
        ...
        {sections.map((section, i) => (
          ...
          >
            ...
            <div className="w-full lg:flex-1 flex flex-col gap-8 lg:px-[48px]">
              <h2 className="text-cma-navy leading-none tracking-[-1px]">{section.heading}</h2>
              ...
              {section.hours && (
                <div className="flex flex-col gap-1">
                  <p className="text-cma-navy">The Museum Store is open when the Museum is open!</p>
                  <p className="text-cma-navy font-black mt-2">Monday–Sunday: 10:00 AM – 5:00 PM</p>
                </div>
              )}
              ...
              {section.ctas && (
                <div className="flex flex-col sm:flex-row gap-3">
                  {section.ctas.map((cta) => (
                    <a key={cta.label} href={cta.href} className={cta.style}>{cta.label}</a>
                  ))}
                </div>
              )}
            </div>
