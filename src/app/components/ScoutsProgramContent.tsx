...
const workshopWeekends = [
	{
		...
		description:
			"Scouts will earn their Coding for Good STEM badge in this hands-on workshop. Learn coding basics and work together to overcome challenges by using this powerful tool.",
		href: "#",
	},
	{
		date: "November 14–15",
		...
		description:
			"Scouts can work toward earning their Craft and Tinker badge and learn about the engineering process by inventing, designing, and building a prototype of a toy. Participants will use imaginative play and critical thinking to create a toy out of materials provided.",
		href: "#",
	},
	{
		date: "February 6–7",
		...
		description:
			"Girl Scouts will learn all about what robots are and the different tasks robots can be designed to do. Participants will then use engineering concepts to work together to design a robot to help in the event of a natural disaster, and learn ways that robots help people in the real world.",
		href: "#",
	},
	{
		date: "March 13–14",
		...
		description:
			"Scouts will learn the basics of car design, assess customer needs, and use the design thinking process to sketch and sculpt 3D models of their dream vehicles.",
		href: "#",
	},
];
...
const workshopDetails = [
	...
	},
	{
		...
		description:
			"3-hour total experience: up to 1 hour of workshop programming followed by 2 hours of playtime on the Museum floor.",
	},
	{
		icon: faUsers,
		color: "bg-cma-slate",
	...
	},
	{
		...
		description:
			"Scouts receive a certificate of completion and a Museum Fun Patch. All official badges must be ordered through Girl Scouts of America.",
	},
];
					...
					<aside className="hidden lg:flex flex-col gap-[20px] w-[210px] shrink-0 sticky top-[140px] self-start">
						...
						<div className="bg-cma-navy rounded-[20px] p-[20px] flex flex-col gap-[12px]">
							<p className="font-extrabold text-[14px] text-white leading-[1.3]">
								Join our Scout Newsletter!
							</p>
							<p className="text-white/75 text-[13px] leading-[1.5]">
								Be the first to know about upcoming Scout programs, badge
					...
					<div className="flex-1 min-w-0">
						<div className="bg-white rounded-[24px] border-2 border-black/5 p-[24px] md:p-[48px] flex flex-col gap-[32px] md:gap-[48px]">
							...
							<div id="overview" className="flex flex-col gap-[24px]">
								<img
									src={imgHero}
									alt="Scout Workshops at Children's Museum of Atlanta"
									className="w-full h-[220px] sm:h-[300px] object-cover rounded-[20px]"
								/>
								<h1 className="text-cma-navy !text-[clamp(28px,3.75vw,48px)] !leading-[1.05] !tracking-[-1px] !font-extrabold">
									Scout Workshops
								</h1>
								<p className="text-cma-navy">
									From badge-earning workshops to special events like our
									overnight adventures, our STEM based, hands-on programs are
									designed to engage scouts, spark curiosity, and make learning
									fun.
								</p>
								<p className="text-cma-navy">
									Currently serving Girl Scouts, and soon welcoming Scouts of
									America, this is your one-stop spot to explore and plan your
									scout's next adventure.
								</p>
								<div className="flex flex-col sm:flex-row flex-wrap gap-[12px]">
									<button
										onClick={() => scrollToSection("workshop-weekends")}
								...
								<div className="flex flex-col gap-[16px]">
									{workshopWeekends.map((workshop, i) => (
										...
										>
											...
											<a
												href={workshop.href}
												className="cma-btn cma-btn-outline-teal font-black self-start"
											>
												Reserve Your Troop's Spot{" "}
												<FontAwesomeIcon
													icon={faArrowRight}
							...
							<div id="on-demand" className="flex flex-col gap-[24px]">
								...
								<p className="text-cma-navy">
									Workshop weekends don't work for your troop? Never fear! Our
									Craft and Tinker and What Robots Do workshops are available
									on-demand on weekends. Request your workshop below.
								</p>
							...
							<div id="sleepover" className="flex flex-col gap-[24px]">
								...
								<p className="text-cma-navy">
									This overnight experience blends classic slumber party fun
									with hands-on STEAM learning. It offers young Girl Scouts an
									exciting and supportive introduction to an overnight adventure
									in the safe, indoor setting of Children's Museum of Atlanta.
								</p>
								<p className="text-cma-navy">
									During this special overnight, scouts will enjoy exclusive
									after-hours access to the Museum, guided group activities, and
									engaging STEAM-based slumber party stations designed to spark
									curiosity and creativity.
								</p>
								<p className="text-cma-navy">
									Time for group play and a guided wind-down will help scouts
									bond with their troop, practice independence, and build
									friendships in a fun, supportive overnight setting.
								</p>
								<div className="bg-cma-navy rounded-[20px] p-[24px] md:p-[32px] flex flex-col gap-[12px]">
									...
									<p className="text-white font-extrabold text-[20px] leading-[1.2]">
										Stay tuned for 2027 dates!
									</p>
									<p className="text-white/70">
										Sign up for the Scout Newsletter to be the first to know
										when sleepover dates are announced.
									</p>
									<button
							...
							<div id="newsletter" className="flex flex-col gap-[24px]">
								...
								<p className="text-cma-navy">
									...
									upcoming Scout programs, badge workshops, and museum events.
								</p>
