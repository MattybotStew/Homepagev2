			...
			<div className="cma-section-container flex flex-col lg:flex-row gap-12 lg:gap-[80px] items-start">
				...
				<div className="flex-1 flex flex-col gap-8">
					...
					>
						...
						<p className="text-cma-navy max-w-[520px]">
							Founded in 1988, Children's Museum of Atlanta opened its permanent
							home in Centennial Olympic Park in 2003. Since then, it has become
							Atlanta's premier destination for hands-on, exploratory learning
							for young children — a recognized authority on informal learning
							and a signature element of Atlanta's cultural landscape.
						</p>
					</motion.div>
				...
				>
					<div className="rounded-[24px] overflow-hidden h-[360px] lg:h-[560px]">
						<img
							src={imgHistory}
							alt="Children's Museum of Atlanta building exterior"
