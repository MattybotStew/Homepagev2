		...
		>
					...
					<div className="flex-1 flex flex-col gap-6 md:gap-[40px]">
						...
						>
							<p className="font-medium text-[clamp(15px,2vw,18px)] text-cma-blue-light leading-[1.7]">
								...
								experiences that are critical to their development. Your gift
								sparks curiosity and builds school-ready kids across our
			...
			>
				{Array.from({ length: 10 }).map((_, i) => (
					<img
						key={`item-${i}`}
						src={bottomWave === "white" ? imgWaveWhite : imgWaveBottom}
						alt=""
						className="w-[422px] h-[57px] shrink-0 block"
					/>
				))}
