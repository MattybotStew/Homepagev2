			...
			<div className="cma-section-container">
				...
				>
					...
					<div className="flex flex-wrap justify-center gap-[8px] p-[8px] rounded-2xl sm:rounded-[200px] bg-white border border-[rgba(107,126,160,0.25)] w-full sm:w-auto">
						...
						>
							<span
								className={`font-extrabold text-[14px] leading-[1.14] whitespace-nowrap ${tab === "membership" ? "text-white" : "text-cma-navy"}`}
							>
								Family Membership
							</span>
							<span
								className={`flex items-center justify-center px-[8px] py-[4px] rounded-full ${tab === "membership" ? "bg-white" : "bg-[rgba(247,148,30,0.1)]"}`}
							>
								<span
									className={`font-extrabold text-[10px] tracking-[0.5px] uppercase whitespace-nowrap ${tab === "membership" ? "text-cma-navy" : "text-cma-orange-dark"}`}
								>
									Best Value
								</span>
							</span>
						...
						>
							<span
								className={`font-extrabold text-[14px] leading-[1.14] whitespace-nowrap ${tab === "single" ? "text-white" : "text-cma-navy"}`}
							>
								Single Visit
							</span>
						</button>
					...
					{tab === "membership" ? (
						...
						>
							...
							<div className="flex items-center gap-[10px] self-center rounded-[20px] px-[16px] py-[8px] bg-white border border-[rgba(107,126,160,0.25)]">
								<FontAwesomeIcon
									icon={faBolt}
									className="text-cma-orange text-[13px] shrink-0"
									aria-hidden
								/>
