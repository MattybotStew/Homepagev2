...
export default function EducatorsPrograms() {
  return (
    <section id="programs" className="bg-cma-teal-pale w-full py-[80px] md:py-[120px] relative">
      <div className="cma-section-container flex flex-col gap-[48px]">
        ...
        >
          ...
          <p className="text-cma-navy max-w-[560px]">
            Discover the range of programs we offer for schools, scouts, and lifelong learners.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-[16px]">
          {programs.map((program, i) => (
            ...
            >
              ...
              <p className="font-extrabold text-[22px] text-cma-navy leading-[1.2] tracking-[-0.5px]">{program.title}</p>
