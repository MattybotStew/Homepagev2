			...
			<div className="cma-section-container flex flex-col lg:flex-row gap-10 lg:gap-[80px] items-center">
				...
				<div className="w-full lg:flex-1 flex flex-col gap-8">
					...
					>
						...
						<p className="text-cma-navy">
							CMA is more than a museum — we're a nonprofit dedicated to
							bringing play and learning to every child in Atlanta, including
							those who might not otherwise have access.
						</p>
					</motion.div>
				...
				>
					<div className="rounded-[24px] overflow-hidden h-[320px] lg:h-[480px]">
						<img
							src={imgPlay}
							alt="Child playing at the museum"
