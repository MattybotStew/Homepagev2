          ...
          <div className="w-full lg:w-[340px] shrink-0 flex flex-col gap-3">
            {stats.map((stat, i) => (
              ...
              >
                ...
                <p className="text-white font-bold text-[14px] leading-snug">{stat.label}</p>
                <p className={`text-[12px] leading-[1.4] ${stat.orange ? "text-white/80" : "text-cma-blue-light"}`}>
                  {stat.sub}
                </p>
              </motion.div>
            ))}
