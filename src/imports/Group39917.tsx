...
function HelloBar() {
	return (
		<div
			className="absolute bg-[#00adbb] content-stretch flex h-[36px] items-center justify-between left-0 px-[20px] py-[10px] top-0 w-[1440px]"
			data-name="Hello Bar"
		>
			<Frame4 />
			<Frame3 />
			...
			<div className="absolute inset-[0_-0.25%_0_0]">
				...
				>
					<g id="Group 3">
						...
						/>
						<path
							d={svgPaths.p3cdb3200}
							fill="var(--fill-0, #FAA735)"
							id="eVTOJl2v6Zp7"
						/>
						<path
							d={svgPaths.p31e42c40}
							fill="var(--fill-0, #00ADBD)"
							id="Vector_5"
						/>
						<path
							d={svgPaths.p2a7c1880}
							fill="var(--fill-0, #00ADBD)"
							id="eVTOJl2v6Zp40"
						/>
						<path
							d={svgPaths.p16dbcf00}
							fill="var(--fill-0, #FBB040)"
							id="eVTOJl2v6Zp42"
						/>
						<path
	...
	return (
		<div className="col-1 h-[17.196px] ml-0 mt-0 relative row-1 w-[185.296px]">
			...
			>
				<g id="Group 1">
					<path
						d={svgPaths.p20369400}
						fill="var(--fill-0, #808285)"
						id="Vector"
					/>
					<path
						d={svgPaths.p2793e780}
						fill="var(--fill-0, #808285)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p2fb33f80}
						fill="var(--fill-0, #808285)"
						id="Vector_3"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p21b67300}
						fill="var(--fill-0, #808285)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p3a500640}
						fill="var(--fill-0, #808285)"
						id="Vector_6"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p2bcb1700}
						fill="var(--fill-0, #808285)"
						id="Vector_11"
					/>
					<path
						d={svgPaths.p26ba8c80}
						fill="var(--fill-0, #808285)"
						id="Vector_12"
					/>
					<path
						d={svgPaths.p120a8770}
						fill="var(--fill-0, #808285)"
						id="Vector_13"
					/>
					<path
						d={svgPaths.p1de25500}
						fill="var(--fill-0, #808285)"
						id="Vector_14"
					/>
					<path
						d={svgPaths.p12982000}
						fill="var(--fill-0, #808285)"
						id="Vector_15"
					/>
					<path
						d={svgPaths.p37085ca0}
						fill="var(--fill-0, #808285)"
						id="Vector_16"
					/>
				</g>
	...
	return (
		<div className="col-1 h-[17.177px] ml-0 mt-[56.47%] relative row-1 w-[94.06px]">
			...
			>
				<g id="Group 2">
					<path
						d={svgPaths.p1a112080}
						fill="var(--fill-0, #808285)"
						id="Vector"
					/>
					<path
						d={svgPaths.p39ca3d00}
						fill="var(--fill-0, #808285)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p208d1800}
						fill="var(--fill-0, #808285)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p12f35b2a}
						fill="var(--fill-0, #808285)"
						id="Vector_4"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p2bacee70}
						fill="var(--fill-0, #808285)"
						id="Vector_7"
					/>
					<path
						d={svgPaths.p1a0e7600}
						fill="var(--fill-0, #808285)"
						id="Vector_8"
					/>
					<path
						d={svgPaths.p34eadb80}
						fill="var(--fill-0, #808285)"
						id="Vector_9"
					/>
				</g>
...
function Cmoa() {
	return (
		<div
			className="content-stretch flex flex-[1_0_0] gap-[19px] items-center min-h-px min-w-px overflow-clip relative"
			data-name="cmoa 2"
		>
			<Group3 />
			<Group4 />
...
function Nav() {
	return (
		<div
			className="content-stretch flex items-center justify-center px-[12px] py-[8px] relative shrink-0"
			data-name="nav"
		>
			<p className="font-['Mulish:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#1d3e6b] text-[13px] whitespace-nowrap">
				Plan Your Visit
			</p>
		</div>
	);
...
function ButtonsButton() {
	return (
		<div
			className="bg-[#f7941e] content-stretch flex items-center justify-center overflow-clip px-[16.146px] py-[10.447px] relative rounded-[474.877px] shadow-[0px_0.475px_0.95px_0px_rgba(16,24,40,0.05)] shrink-0"
			data-name="Buttons/Button"
		>
			<p className="font-['Nunito:Bold',sans-serif] font-bold leading-[1.13] relative shrink-0 text-[11.397px] text-white whitespace-nowrap">
				Donate
			</p>
		</div>
	);
...
function ButtonsButton1() {
	return (
		<div
			className="bg-[#00adbb] content-stretch flex items-center justify-center overflow-clip px-[16.146px] py-[10.447px] relative rounded-[474.877px] shadow-[0px_0.475px_0.95px_0px_rgba(16,24,40,0.05)] shrink-0"
			data-name="Buttons/Button"
		>
			<p className="font-['Nunito:Bold',sans-serif] font-bold leading-[1.13] relative shrink-0 text-[11.397px] text-white whitespace-nowrap">
				Memberships
...
function ButtonsButton2() {
	return (
		<div
			className="bg-[#346094] content-stretch flex items-center justify-center overflow-clip px-[16.146px] py-[10.447px] relative rounded-[474.877px] shadow-[0px_0.475px_0.95px_0px_rgba(16,24,40,0.05)] shrink-0"
			data-name="Buttons/Button"
		>
			<p className="font-['Nunito:Bold',sans-serif] font-bold leading-[1.13] relative shrink-0 text-[11.397px] text-white whitespace-nowrap">
				Buy Tickets
...
function Header() {
	return (
		<div
			className="absolute content-stretch flex items-center left-0 px-[20px] py-[17px] top-[36px] w-[1440px]"
			data-name="header"
		>
			<Cmoa />
...
function Progress() {
	return (
		<div
			className="absolute bg-[#f4f4f4] content-stretch flex flex-col items-start left-0 top-[122.52px] w-[1440px]"
			data-name="PROGRESS"
		>
...
function Hero() {
	return (
		<div
			className="absolute content-stretch flex flex-col items-start justify-center left-0 px-[60px] py-[140px] top-[128.52px] w-[1440px]"
			data-name="hero"
		>
...
function Marqueee() {
	return (
		<div
			className="absolute bg-[#1d3e6b] content-stretch flex gap-[30px] items-center justify-center left-0 p-[30px] top-[910.52px] w-[1440px]"
			data-name="marqueee"
		>
			<p className="font-['Nunito:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[39px] text-white whitespace-nowrap">
				Downtown Atlanta
			</p>
			<div
				className="h-[30.962px] relative shrink-0 w-[26.263px]"
				data-name="Vector"
			>
				<svg
					className="absolute block size-full"
...
function Heading() {
	return (
		<div
			className="content-stretch flex flex-col items-center pb-[30px] relative shrink-0 w-full"
			data-name="Heading 1"
		>
...
function Background() {
	return (
		<div
			className="bg-white content-stretch flex flex-col items-start py-[30px] relative shrink-0 w-full"
...
function Background1() {
	return (
		<div
			className="bg-[rgba(0,173,187,0.2)] relative rounded-[10px] shrink-0 w-full"
			data-name="Background"
		>
...
function Container8() {
	return (
		<div
			className="content-stretch flex gap-[12px] isolate items-center py-[15px] relative shrink-0 w-full"
			data-name="Container"
		>
			<div
				aria-hidden="true"
				className="absolute border-[#e8e3d7] border-b border-solid inset-0 pointer-events-none"
			/>
			<div
				className="relative shrink-0 size-[18.05px] z-[2]"
				data-name="Vector"
			>
				<svg
					className="absolute block size-full"
...
function Card() {
	return (
		<div
			className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[26px]"
			data-name="card"
		>
			<div className="content-stretch flex flex-col items-start pb-[20px] px-[20px] relative size-full">
				...
				<Frame9 />
				<div
					className="relative rounded-[1000px] shrink-0 w-full"
					data-name="CTA"
				>
					<div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
						<div className="content-stretch flex items-center justify-center px-[34px] py-[22px] relative w-full">
							<p className="font-['Nunito:Bold',sans-serif] font-bold leading-[1.13] relative shrink-0 text-[#00adbb] text-[24px] whitespace-nowrap">
								Plan Your Visit
							</p>
						</div>
					</div>
					<div
						aria-hidden="true"
						className="absolute border-2 border-[#00adbb] border-solid inset-0 pointer-events-none rounded-[1000px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]"
					/>
				</div>
			</div>
		</div>
...
function Background3() {
	return (
		<div
			className="bg-[rgba(247,148,30,0.2)] relative rounded-[10px] shrink-0 w-full"
			data-name="Background"
		>
			<div className="flex flex-col items-center justify-center size-full">
				<div className="content-stretch flex flex-col gap-[10px] items-center justify-center px-[8px] py-[10px] relative w-full">
...
function Container14() {
	return (
		<div
			className="content-stretch flex isolate items-center justify-between py-[15px] relative shrink-0 w-full"
			data-name="Container"
		>
			<div
				aria-hidden="true"
		...
		>
			<div className="content-stretch flex flex-col items-start pb-[20px] px-[20px] relative size-full">
				...
				>
					<div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
						<div className="content-stretch flex items-center justify-center px-[34px] py-[22px] relative w-full">
							<p className="font-['Nunito:Bold',sans-serif] font-bold leading-[1.13] relative shrink-0 text-[#f7941e] text-[24px] whitespace-nowrap">
								Buy Tickets
							</p>
						</div>
					</div>
					<div
						aria-hidden="true"
						className="absolute border-2 border-[#f7941e] border-solid inset-0 pointer-events-none rounded-[1000px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]"
					/>
				</div>
			</div>
		</div>
...
function Background5() {
	return (
		<div
			className="bg-[rgba(29,62,107,0.2)] h-[51px] relative rounded-[10px] shrink-0 w-full"
			data-name="Background"
		>
			<div className="flex flex-col items-center justify-center size-full">
...
function Card2() {
	return (
		<div
			className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[26px]"
			data-name="card"
		>
			<div className="content-stretch flex flex-col items-start pb-[20px] px-[20px] relative w-full">
				...
				>
					<div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
						<div className="content-stretch flex items-center justify-center px-[34px] py-[22px] relative w-full">
							<p className="font-['Nunito:Bold',sans-serif] font-bold leading-[1.13] relative shrink-0 text-[#346094] text-[24px] whitespace-nowrap">
								Get Directions
							</p>
						</div>
					</div>
					<div
						aria-hidden="true"
						className="absolute border-2 border-[#346094] border-solid inset-0 pointer-events-none rounded-[1000px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]"
					/>
				</div>
			</div>
		</div>
...
function Background7() {
	return (
		<div
			className="bg-[rgba(0,173,187,0)] content-stretch flex flex-col h-[41px] items-center justify-center py-[10px] relative rounded-[10px] shrink-0 w-full"
			data-name="Background"
		>
			<div className="flex flex-col font-['Nunito:SemiBold',sans-serif] font-semibold justify-center leading-[0] overflow-hidden relative shrink-0 text-[#474763] text-[20px] text-ellipsis tracking-[-0.8px] w-full">
...
function BridgeText() {
	return (
		<div
			className="bg-[rgba(0,173,187,0.2)] content-stretch flex gap-[10px] items-center justify-center px-[10px] py-[6px] relative rounded-[20px] shrink-0"
			data-name="BridgeText"
		>
			<p className="font-['Nunito:Bold',sans-serif] font-bold leading-[21px] relative shrink-0 text-[#346094] text-[14px] tracking-[3.5px] uppercase whitespace-nowrap">
...
function Section() {
	return (
		<div
			className="content-stretch flex flex-col gap-[40px] items-center max-w-[1280px] pb-[160px] pt-[140px] relative shrink-0 w-[1280px]"
			data-name="Section"
		>
			<Heading />
			<Cards />
...
function PlanYourVisit() {
	return (
		<div
			className="absolute content-stretch flex flex-col items-center justify-center left-0 top-[1001.48px] w-[1440px]"
			data-name="Plan Your Visit"
		>
			<Section />
		</div>
	);
...
function Heading1() {
	return (
		<div
			className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[1280px]"
			data-name="Heading 1"
		>
			...
			<div
				className="absolute flex h-[31.949px] items-center justify-center left-[0.06px] top-[160.64px] w-[645.661px]"
				style={
					{
						"--transform-inner-width": "1200",
						"--transform-inner-height": "19",
			...
			>
				<div className="flex-none rotate-[-0.76deg] skew-x-[-0.18deg]">
					<div
						className="h-[23.397px] relative w-[645.481px]"
						data-name="eVTOJl2v6Zp43"
					>
...
function DivTrxAddonsImageAccordionItem() {
	return (
		<div
			className="col-1 h-[792px] ml-0 mt-0 overflow-clip relative row-1 w-[744.369px]"
			data-name="div.trx-addons-image-accordion-item"
		>
			<div
				className="absolute h-[720px] left-0 right-[0.37px] rounded-[12px] top-0"
				data-name="div.trx-addons-image-accordion-item-inner"
			>
				<img
					alt=""
					className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[12px] size-full"
					src={imgDivTrxAddonsImageAccordionItemInner}
				/>
			</div>
			...
			<div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[#8d8e8a] text-[14px] top-[782px] whitespace-nowrap">
				<p className="leading-[20px]">
					Climb inside a Tuskegee Airmen plane replica
				</p>
			</div>
		</div>
	);
...
function DivTrxAddonsImageAccordionItem1() {
	return (
		<div
			className="col-1 h-[792px] ml-[764.06px] mt-0 overflow-clip relative row-1 w-[248.123px]"
			data-name="div.trx-addons-image-accordion-item"
		>
			<div
				className="absolute h-[720px] left-0 right-[0.12px] rounded-[12px] top-0"
				data-name="div.trx-addons-image-accordion-item-inner"
			>
				<img
					alt=""
					className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[12px] size-full"
					src={imgDivTrxAddonsImageAccordionItemInner1}
				/>
			</div>
			<div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Medium',sans-serif] font-medium justify-center leading-[0] left-0 text-[#1b3d6d] text-[28px] top-[755px] tracking-[-1.12px] whitespace-nowrap">
...
function DivTrxAddonsImageAccordionItem2() {
	return (
		<div
			className="col-1 h-[792px] ml-[1031.88px] mt-0 overflow-clip relative row-1 w-[248.123px]"
			data-name="div.trx-addons-image-accordion-item"
		>
			<div
				className="absolute h-[720px] left-0 right-[0.12px] rounded-[30px] top-0"
				data-name="div.trx-addons-image-accordion-item-inner"
			>
				<img
					alt=""
					className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[30px] size-full"
					src={imgDivTrxAddonsImageAccordionItemInner2}
				/>
			</div>
			<div className="-translate-y-1/2 absolute flex flex-col font-['Nunito:Medium',sans-serif] font-medium justify-center leading-[0] left-0 text-[#1b3d6d] text-[28px] top-[755px] tracking-[-1.12px] whitespace-nowrap">
...
function BridgeText1() {
	return (
		<div
			className="bg-[#cceff1] content-stretch flex gap-[10px] items-center justify-center px-[10px] py-[6px] relative rounded-[20px] shrink-0"
			data-name="BridgeText"
		>
			<p className="font-['Nunito:Bold',sans-serif] font-bold leading-[21px] relative shrink-0 text-[#346094] text-[14px] tracking-[3.5px] uppercase whitespace-nowrap">
...
function Section1() {
	return (
		<div
			className="content-stretch flex flex-col gap-[40px] items-center max-w-[1280px] py-[120px] relative shrink-0 w-[1280px]"
			data-name="Section"
		>
			<Frame13 />
			<Group5 />
...
function Statue() {
	return (
		<div
			className="absolute contents left-[1162px] top-[-141.72px]"
			data-name="statue"
		>
			<div className="absolute h-[20.889px] left-[1162px] top-[212.42px] w-[188px]">
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 188 20.8889"
				>
					<ellipse
						cx="94"
						cy="10.4444"
						fill="url(#paint0_linear_15_2879)"
						id="Ellipse 3"
						rx="94"
						ry="10.4444"
					/>
			...
			<div
				className="absolute h-[375.028px] left-[1162px] top-[-141.72px] w-[187.028px]"
				data-name="statue handstand@1-1920x968 (1) 1"
			>
				<div className="absolute inset-0 overflow-hidden pointer-events-none">
					<img
						alt=""
...
function PlanYourVisit1() {
	return (
		<div
			className="absolute content-stretch flex flex-col items-center justify-center left-0 top-[1995.68px] w-[1440px]"
			data-name="Plan Your Visit"
		>
			<Section1 />
			<Statue />
...
export default function Group6() {
	return (
		<div className="relative size-full">
			<HelloBar />
			<div
				className="absolute h-[1585px] left-[48px] top-[1001px] w-[1344px]"
				data-name="Vector"
			>
				<svg
					className="absolute block size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 1344 1585"
				>
					<path
						d={svgPaths.p25027840}
						fill="var(--fill-0, #F7941E)"
						id="Vector"
						opacity="0.2"
					/>
