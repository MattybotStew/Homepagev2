...
function CustomImg001CopyrightJpg() {
	return (
		<div
			className="-translate-x-1/2 absolute left-[calc(50%-600px)] size-[240px] top-0"
			data-name="custom-img-001-copyright.webp"
		>
			<img
				alt=""
				className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
				src={imgCustomImg001CopyrightJpg}
			/>
		</div>
	);
}
...
function CustomImg002CopyrightJpg() {
	return (
		<div
			className="-translate-x-1/2 absolute left-[calc(50%-360px)] size-[240px] top-0"
			data-name="custom-img-002-copyright.webp"
		>
			<img
				alt=""
				className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
...
function CustomImg003CopyrightJpg() {
	return (
		<div
			className="-translate-x-1/2 absolute left-[calc(50%-120px)] size-[240px] top-0"
			data-name="custom-img-003-copyright.webp"
		>
			<img
				alt=""
				className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
				src={imgCustomImg003CopyrightJpg}
			/>
		</div>
	);
}
...
function CustomImg004CopyrightJpg() {
	return (
		<div
			className="-translate-x-1/2 absolute left-[calc(50%+120px)] size-[240px] top-0"
			data-name="custom-img-004-copyright.webp"
		>
			<img
				alt=""
				className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
...
function CustomImg005CopyrightJpg() {
	return (
		<div
			className="-translate-x-1/2 absolute left-[calc(50%+360px)] size-[240px] top-0"
			data-name="custom-img-005-copyright.webp"
		>
			<img
				alt=""
				className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
				src={imgCustomImg005CopyrightJpg}
			/>
		</div>
	);
}
...
function CustomImg006CopyrightJpg() {
	return (
		<div
			className="-translate-x-1/2 absolute left-[calc(50%+600px)] size-[240px] top-0"
			data-name="custom-img-006-copyright.webp"
		>
			<img
				alt=""
				className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
				src={imgCustomImg006CopyrightJpg}
			/>
		</div>
	);
}
...
function Frame() {
	return (
		<div
			className="absolute left-[28px] size-[24px] top-[28px]"
			data-name="Frame"
		>
			<svg
			...
			>
				<g id="Frame">
					<path
						d={svgPaths.p3bcd3c00}
						fill="var(--fill-0, #1A0604)"
						id="Vector"
					/>
				</g>
			</svg>
...
function AElementorIcon() {
	return (
		<div
			className="-translate-x-1/2 absolute bg-[#fffefe] left-1/2 rounded-[40px] size-[80px] top-[76px]"
			data-name="a.elementor-icon"
		>
			<Frame />
		</div>
	);
