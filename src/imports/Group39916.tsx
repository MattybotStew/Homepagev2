...
function CustomImg001CopyrightJpg() {
  return (
    <div className="-translate-x-1/2 absolute left-[calc(50%-600px)] size-[240px] top-0" data-name="custom-img-001-copyright.jpg">
...
function CustomImg002CopyrightJpg() {
  return (
    <div className="-translate-x-1/2 absolute left-[calc(50%-360px)] size-[240px] top-0" data-name="custom-img-002-copyright.jpg">
...
function CustomImg003CopyrightJpg() {
  return (
    <div className="-translate-x-1/2 absolute left-[calc(50%-120px)] size-[240px] top-0" data-name="custom-img-003-copyright.jpg">
...
function CustomImg004CopyrightJpg() {
  return (
    <div className="-translate-x-1/2 absolute left-[calc(50%+120px)] size-[240px] top-0" data-name="custom-img-004-copyright.jpg">
...
function CustomImg005CopyrightJpg() {
  return (
    <div className="-translate-x-1/2 absolute left-[calc(50%+360px)] size-[240px] top-0" data-name="custom-img-005-copyright.jpg">
...
function CustomImg006CopyrightJpg() {
  return (
    <div className="-translate-x-1/2 absolute left-[calc(50%+600px)] size-[240px] top-0" data-name="custom-img-006-copyright.jpg">
