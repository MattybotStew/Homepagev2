...
export default function PlanYourVisit() {
	return (
		...
		>
			<div
				className="-translate-x-1/2 absolute bottom-[-343.81px] flex items-center justify-center left-1/2 size-[2499.057px]"
				style={
					{
				...
				<div className="flex-none rotate-[32.22deg]">
					<div className="relative size-[1812px]">
						<svg
							...
							fill="none"
							preserveAspectRatio="none"
							viewBox="0 0 1811.36 1810.72"
						>
							<path
								d={svgPaths.p394a1000}
								fill="var(--fill-0, #FFF6E9)"
								id="Star 1"
							/>
						</svg>
					</div>
