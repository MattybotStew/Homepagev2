...
function Frame() {
	return (
		<div className="content-stretch flex flex-col gap-[50px] items-start justify-center relative shrink-0 w-[768px]">
			<p className="font-['Nunito:Bold',sans-serif] font-bold leading-none opacity-90 relative shrink-0 text-[86px] text-white tracking-[-3.44px] w-[581px]">
...
export default function BottomCallToAction() {
	return (
		<div
			className="content-stretch flex flex-col items-start justify-center px-[60px] py-[100px] relative size-full"
			data-name="bottom Call to action"
		>
