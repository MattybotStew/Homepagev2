...
export default function MuseumHours() {
	return (
		<button className="w-full cursor-pointer" data-name="MuseumHours">
			<div
				className="bg-white flex flex-col items-start rounded-[16px] shadow-[0px_4px_20px_0px_rgba(247,148,30,0.15)] w-full"
				data-name="Button"
			>
				<div
					className="flex gap-[12px] h-[64px] items-center px-[16px] w-full"
					data-name="Container"
				>
					<div
					...
					>
						<div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[2px] items-start relative size-full">
							<div
								...
								data-name="Container"
							>
								<p className="absolute font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[16px] left-0 text-[#1b3d6d] text-[12px] text-left top-[-0.5px] whitespace-nowrap">
									Opening Times Today
								</p>
							</div>
							<div
								...
								data-name="Container"
							>
								<p className="absolute font-['Quicksand:Bold',sans-serif] font-bold leading-[20px] left-0 text-[#f7941e] text-[14px] text-left top-0 whitespace-nowrap">
