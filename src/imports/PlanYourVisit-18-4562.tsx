...
function Heading() {
	return (
		<div
			className="content-stretch flex flex-col gap-[40px] items-center leading-[0] relative shrink-0 w-[1280px]"
			data-name="Heading 1"
		>
...
function Background() {
	return (
		<div
			className="content-stretch flex flex-col items-start py-[30px] relative shrink-0 w-full"
		...
		<div className="content-stretch flex flex-col gap-[34px] items-start justify-center pb-[44px] pt-[20px] relative shrink-0 w-full">
			<div className="flex flex-col font-['Josefin_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] overflow-hidden relative shrink-0 text-[#474763] text-[0px] text-ellipsis tracking-[-0.8px] w-full">
				<p className="text-[20px]">
					<span className="font-['Nunito:Bold',sans-serif] font-bold leading-[40px] text-[#f7941e] text-[40px]">
						$17.95
					</span>
					<span className="font-['Nunito:Bold',sans-serif] font-bold leading-[20px] text-[#4a5568]">{`/person `}</span>
					<span className="font-['Nunito:Regular',sans-serif] font-normal leading-[24px] text-[#4a5568] text-[16px]">
						Family of 4: $71.80
					</span>
				</p>
			</div>
			<p className="font-['Nunito:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[#78787a] text-[20px] w-full">
...
function Card() {
	return (
		<div
			className="bg-[#fff6e9] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[26px]"
			data-name="card"
		>
			<div
				aria-hidden="true"
				className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-[-1px] pointer-events-none rounded-[27px]"
			/>
...
function Background1() {
	return (
		...
		>
			...
			<div
				className="-translate-y-1/2 absolute bg-[#f7941e] content-stretch flex flex-col gap-[10px] items-start px-[12px] py-[8px] right-[-7px] rounded-[1000px] top-[calc(50%-17.89px)] w-[120px]"
				data-name="tag"
			>
				...
				<div
					className="absolute flex h-[36.281px] items-center justify-center left-[87px] top-[-6px] w-[27.713px]"
					style={
						{
				...
				>
					<div className="flex-none rotate-[118.46deg]">
						<div
							className="h-[12.965px] relative w-[34.24px]"
							data-name="eVTOJl2v6Zp40"
						>
							<svg
								className="absolute block size-full"
								fill="none"
								preserveAspectRatio="none"
								viewBox="0 0 34.2401 12.9647"
							>
								<path
									d={svgPaths.p17840200}
									fill="var(--fill-0, #1D3E6B)"
									id="eVTOJl2v6Zp40"
								/>
							</svg>
						</div>
...
function Frame2() {
	return (
		<div className="content-stretch flex flex-col gap-[34px] items-start justify-center pb-[44px] pt-[20px] relative shrink-0 w-full">
			<div className="flex flex-col font-['Josefin_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] overflow-hidden relative shrink-0 text-[#474763] text-[0px] text-ellipsis tracking-[-0.8px] w-full">
				<p className="text-[20px]">
					<span className="font-['Nunito:Bold',sans-serif] font-bold leading-[40px] text-[#00adbb] text-[40px]">
						$149
					</span>
...
function Cards() {
	return (
		<div
			className="content-stretch flex gap-[30px] h-[325.04px] items-center relative shrink-0 w-full"
			data-name="cards"
		>
...
function Section() {
	return (
		<div
			className="content-stretch flex flex-col gap-[70px] items-center max-w-[1280px] pb-[140px] pt-[160px] relative shrink-0 w-[1280px]"
			data-name="Section"
		>
			<Frame1 />
			<Cards />
...
export default function PlanYourVisit() {
	return (
		<div
			className="content-stretch flex flex-col items-center justify-center relative size-full"
